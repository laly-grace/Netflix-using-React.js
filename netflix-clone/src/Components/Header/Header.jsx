...
const navItems = ["Popular Now", "Plans", "Reasons to Join", "FAQ", "Sign In"];
  ...
  return (
    <Box sx={{ display: "flex" }}>
      ...
      <AppBar
        ...
        elevation={0}
        sx={{
          backgroundColor: "rgba(211, 202, 202, 0.3)", // Light translucent white
          ...
          >
            ...
            >
              <svg
                ...
                aria-hidden="true"
                role="img"
                class="default-ltr-cache-17nnie8-StyledBrandLogo ev1dnif2"
              >
                <g>
